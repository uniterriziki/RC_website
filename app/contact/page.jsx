...
const page = () => {
  return (
    <div className="antialiased">
      <div className="flex w-full min-h-screen justify-center items-center">
        <div className="flex flex-col space-y-6 bg-slate-300 w-full max-w-4xl p-8 rounded-xl shadow-lg text-primary-dark">
          {/* contact info div */}
          <div className="flex flex-col space-y-8 justify-between">
            <div>
            ...
            <div>
              <div className="inline-flex space-x-2 items-center text-primary-dark">
                {/* insert location icon here */}
                <span>University of Nairobi, KNH campus</span>
              </div>
            </div>
          </div>
          ...
          {/* contact form div */}
          {/* <div>
            <div className="bg-white rounded-xl shadow-lg p-8 text-primary">
              <form>contact form</form>
            </div>
          </div> */}
        </div>
